...
const SettingsConfig = [
  ...
  },
  {
    ...
    questionMark: {
      title:
        "Note: Work in progress & only usefull for HDR videos.\n\nNormally your browser's color space is automatically detected for HDR videos.\nBut with this settings you can always force a color space.\nHowever, note that your browser might throw errors for a color space it does not fully support.",
    },
    type: 'list',
    default: 0,
    min: 0,
    ...
    snapPoints: [
      { value: 0, label: 'Auto' },
      { value: 1, label: 'sRGB' },
      { value: 2, label: 'Display P3 D65' },
      { value: 3, label: 'Rec. 2100 PQ', flip: true },
      { value: 4, label: 'Rec. 2100 HLG' },
    ],
    manualinput: false,
    advanced: true,
    experimental: true,
  },
  {
    ...
    questionMark: {
      title:
        "Note: Work in progress & only usefull for HDR videos.\n\nIn the future the 'auto' value will switch to the correct bit depth for HDR videos.\nCurrently the 'auto' value always defaults to 8-bit.",
    },
    type: 'list',
    default: 0,
    min: 0,
  ...
  {
    name: 'colorConversionPatch',
    label: 'Color conversion patch',
    questionMark: {
      title:
        'Note: Only usefull for HDR videos.\n\nBy default this patch is only enabled for HDR videos.\nThis patch lets the browser do the color conversion for us by drawing the video frame to a CanvasRenderingContext2D first.',
    },
    type: 'list',
    default: 0,
    min: 0,
